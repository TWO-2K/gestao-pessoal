            ...
            return (
              <div key={conta.id} className="group flex items-center gap-4 rounded-2xl border border-ink-200 bg-white px-4 py-3.5">
                <button
                  ...
                  className={cn(
                    "h-9 w-9 flex-shrink-0 rounded-full flex items-center justify-center border-2 transition-colors",
                ...
                <p className={cn("font-mono font-semibold tabular-nums", pago && "text-ink-400")}>{formatCurrency(conta.valor)}</p>
